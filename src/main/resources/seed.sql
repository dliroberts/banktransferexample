...
insert into accounts (iban, currencyCode, balance, customerId) values ('FR9476231310567227640169067', 'EUR', '32432843298.11', 1);
insert into accounts (iban, currencyCode, balance, customerId) values ('ES2364265841767173822054', 'EUR', '123', 2);
